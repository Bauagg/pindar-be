...
export const updateCustomer = async (req, res, next) => {
  try {
    ...
    const { email, fullName, userName, phoneNumber, address, imageId } =
      req.body;
    ...
    await createNotification({
      ...
      detail: `Kamu telah melakukan update profile ${formattedDate} pukul ${formattedTime}`,
      link: "",
    });
  } catch (error) {
    next(error);
...
export const changePassword = async (req, res, next) => {
  try {
    ...
    await createNotification({
      ...
      detail: `Kamu telah melakukan perubahan password ${formattedDate} pukul ${formattedTime}`,
      link: "",
    });
  } catch (error) {
    next(error);
